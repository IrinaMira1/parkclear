...
const GMI_BASE_URL = import.meta.env.VITE_GMI_BASE_URL || 'https://api.gmi-serving.com';
export async function getNearbyParking(lat, lng, radius = 2000) {
...
export async function getParkingPrice(garage) {
...
export async function scanParkingSign(imageData) {
